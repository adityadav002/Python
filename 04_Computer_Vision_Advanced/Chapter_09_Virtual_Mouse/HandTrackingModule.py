...
class handDetector():
    ...
    def findDistance(self, p1, p2, frame=None, draw=True, r=10, t=3):
        """Finds distance between two landmark points p1 and p2.
        p1, p2: landmark indices
        Returns: distance, midpoint, optional drawing on frame
        """
...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            # Show landmark 8 position
            print("Index Finger Tip:", lmList[8])

            # Draw distance between index finger tip (8) and thumb tip (4)
            distance, info = detector.findDistance(4, 8, frame)

            # Print distance
            print("Distance between thumb and index:", int(distance))
